...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    // 2. Initialize Sensor Listener
    _sensorService.initialize();

    // 3. Setup Pulse Animation (Breathing Effect)
    ...
    // 4. Listen for Real Sensor Crashes
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // -----------------------------------------------------------
                // 5. HACKATHON DEMO CONTROLS (SECRET MENU)
                // -----------------------------------------------------------
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          // BUTTON A: FORCE FALSE ALARM
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () {
                                // 2.2G -> False Alarm Logic
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const EmergencyScreen(gForce: 2.2),
                                  ),
                                );
                              },
                              style: ElevatedButton.styleFrom(
                              ...
                              child: const Text("Test False Alarm"),
                            ),
                          ),
                          const SizedBox(width: 10),
                          // BUTTON B: FORCE REAL CRASH
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () {
                                // 8.8G -> Critical Crash Logic
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const EmergencyScreen(gForce: 8.8),
                                  ),
                                );
                              },
                              style: ElevatedButton.styleFrom(
